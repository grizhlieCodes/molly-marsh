...
import { STRIPE_SECRET_KEY, STRIPE_SIGNING_SECRET, INTERNAL_API_KEY } from '$env/static/private';
...
export async function POST(event) {
	...
	try {
		const stripeEvent = stripe.webhooks.constructEvent(body, signature, STRIPE_SIGNING_SECRET);
