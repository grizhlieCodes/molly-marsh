...
// import { renderRichText } from '@storyblok/svelte';
// import { PUBLIC_STORYBLOK_ACCESS_TOKEN } from '$env/static/public';
// import { SECRET_MAILER_LITE_KEY } from '$env/static/private';
// import mjml2html from 'mjml';
...
// // MailerLite campaign functions

// const MAILERLITE_GROUP_ID = "146246224255649462"

// async function createMailerLiteCampaign(title, htmlContent) {
// 	const response = await fetch('https://api.mailerlite.com/api/v2/campaigns', {
// 		method: 'POST',
// 		headers: {
// 			'Content-Type': 'application/json',
// 			'X-MailerLite-ApiKey': SECRET_MAILER_LITE_KEY
// 		},
// 		body: JSON.stringify({
// 			subject: title,
...
// 			type: 'regular',
// 			html: htmlContent,
// 			from: 'molly@mollymarshcoaching.com',
// 			from_name: 'Molly Marsh'
// 		})
// 	});

// 	if (!response.ok) {
// 		const errorData = await response.json();
// 		console.error('Error creating MailerLite campaign:', errorData);
// 		throw error(500, `MailerLite API error: ${errorData.message || 'Unknown error'}`);
// 	}
...
// 		const campaignData = await createMailerLiteCampaign(storyData.name, html);
