<script lang="ts">
	...
	let allInputStyles: any = {
		fancy: {
			...
			textAreaStyles: `h-[8rem] max-h-[3rem] w-full rounded-md border-b border-molly-dark-300 bg-molly-dark-50 px-3 py-2.5 outline-none transition-all duration-500 focus:border-molly-dark-500 focus:bg-molly-dark-100/70  group-focus-within:max-h-[10rem] overflow-hidden focus:overflow-scroll text-molly-dark-500 group-focus-within:text-neutral-800`,
		...
		basic: {
			...
			textAreaStyles: `w-full bg-white px-2 py-2.5 placeholder:text-body-neutral-400 placeholder:font-light border border-surface-secondary-300 focus-within:border-surface-primary-600 rounded-md outline-0 focus-within:text-body-neutral-800 text-body-neutral-500 font-[350] 
