...
export const maxWidthOptions: Type.SpacingOptions = {
	def: { '20': 'max-w-max', '19': 'max-w-7xl', '18': 'max-w-6xl', '17': 'max-w-5xl', '16': 'max-w-4xl', '15': 'max-w-3xl', '14': 'max-w-2xl', '13': 'max-w-xl', '12': 'max-w-lg', '11': 'max-w-md', '10': 'max-w-sm', '9': 'max-w-64', '8': 'max-w-56', '7': 'max-w-48', '6': 'max-w-40', '5': 'max-w-32', '4': 'max-w-24', '3': 'max-w-16', '2': 'max-w-8', '1': 'max-w-6', '0': '' },
	mm: { '20': 'mm:max-w-max', '19': 'mm:max-w-7xl', '18': 'mm:max-w-6xl', '17': 'mm:max-w-5xl', '16': 'mm:max-w-4xl', '15': 'mm:max-w-3xl', '14': 'mm:max-w-2xl', '13': 'mm:max-w-xl', '12': 'mm:max-w-lg', '11': 'mm:max-w-md', '10': 'mm:max-w-sm', '9': 'mm:max-w-64', '8': 'mm:max-w-56', '7': 'mm:max-w-48', '6': 'mm:max-w-40', '5': 'mm:max-w-32', '4': 'mm:max-w-24', '3': 'mm:max-w-16', '2': 'mm:max-w-8', '1': 'mm:max-w-6', '0': '' },
	lm: { '20': 'lm:max-w-max', '19': 'lm:max-w-7xl', '18': 'lm:max-w-6xl', '17': 'lm:max-w-5xl', '16': 'lm:max-w-4xl', '15': 'lm:max-w-3xl', '14': 'lm:max-w-2xl', '13': 'lm:max-w-xl', '12': 'lm:max-w-lg', '11': 'lm:max-w-md', '10': 'lm:max-w-sm', '9': 'lm:max-w-64', '8': 'lm:max-w-56', '7': 'lm:max-w-48', '6': 'lm:max-w-40', '5': 'lm:max-w-32', '4': 'lm:max-w-24', '3': 'lm:max-w-16', '2': 'lm:max-w-8', '1': 'lm:max-w-6', '0': '' },
	md: { '20': 'md:max-w-max', '19': 'md:max-w-7xl', '18': 'md:max-w-6xl', '17': 'md:max-w-5xl', '16': 'md:max-w-4xl', '15': 'md:max-w-3xl', '14': 'md:max-w-2xl', '13': 'md:max-w-xl', '12': 'md:max-w-lg', '11': 'md:max-w-md', '10': 'md:max-w-sm', '9': 'md:max-w-64', '8': 'md:max-w-56', '7': 'md:max-w-48', '6': 'md:max-w-40', '5': 'md:max-w-32', '4': 'md:max-w-24', '3': 'md:max-w-16', '2': 'md:max-w-8', '1': 'md:max-w-6', '0': '' },
	lg: { '20': 'lg:max-w-max', '19': 'lg:max-w-7xl', '18': 'lg:max-w-6xl', '17': 'lg:max-w-5xl', '16': 'lg:max-w-4xl', '15': 'lg:max-w-3xl', '14': 'lg:max-w-2xl', '13': 'lg:max-w-xl', '12': 'lg:max-w-lg', '11': 'lg:max-w-md', '10': 'lg:max-w-sm', '9': 'lg:max-w-64', '8': 'lg:max-w-56', '7': 'lg:max-w-48', '6': 'lg:max-w-40', '5': 'lg:max-w-32', '4': 'lg:max-w-24', '3': 'lg:max-w-16', '2': 'lg:max-w-8', '1': 'lg:max-w-6', '0': '' }
};
