...
export interface ContainerStoryblok {
	metaData?: any;
	blocks: (ButtonStoryblok | ContainerStoryblok | CustomHeroStoryblok | HeaderStoryblok | IconStoryblok | ImageStoryblok | NavLinkStoryblok | NavLogoStoryblok | PageStoryblok | SectionStoryblok | SimpleTextStoryblok | TextStoryblok)[];
	container_id?: string;
...
export interface TextStoryblok {
	...
	Styling?: any;
	text_style: 'h1' | 'h2' | 'h3' | 'h4' | 'h6' | 'h7' | 'paraXs' | 'paraSm' | 'paraBase' | 'paraLg' | 'paraXl' | 'overline' | 'quote' | 'sr';
